...
addon_info = {
	...
	"addon_name": "youtubeDownloadHelper",
	# Add-on summary, usually the user visible name of the addon.
	# Translators: Summary for this add-on
	# to be shown on installation and add-on information found in Add-ons Manager.
	"addon_summary": _("Youtube Download Helper"),
	# Add-on description
	# Translators: Long description to be shown for this add-on on add-on information from add-ons manager
	"addon_description": _("""This NVDA add-on helps to download youtube videos, with the help of Savefrom.net website.
Just stand on the page of the video you want to download, and press the addon gesture.
You will be directed to Savefrom.net page, where you find the download link."""),
	# version
	"addon_version": "0.1",
	# Author(s)
	"addon_author": "Ibrahim Hamadeh<ibra.hamadeh@hotmail.com>",
	# URL for the add-on documentation support
	"addon_url": "https://github.com/ibrahim-s/youtubeDownloadHelper",
	# URL for the add-on repository where the source code can be found
	"addon_sourceURL": "https://github.com/ibrahim-s/youtubeDownloadHelper",
...
pythonSources = ["addon/globalPlugins/youtubeDownloadHelper/*.py"]
